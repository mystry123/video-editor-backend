...
export interface IUser extends Document {
  ...
  quotaUsage: {
    ...
    captionProjectsUsed: number;
    captionRenderMinutesUsed: number;
    captionExportsUsed: number;
    customPresetsUsed: number;
    lastUpdated: Date;
    lastReset?: Date;
  };
...
const UserSchema = new Schema<IUser>(
  {
    ...
    quotaUsage: {
      storageUsed: { type: Number, default: 0 },
      renderMinutesUsed: { type: Number, default: 0 },
      transcriptionMinutesUsed: { type: Number, default: 0 },
      captionProjectsUsed: { type: Number, default: 0 },
      captionRenderMinutesUsed: { type: Number, default: 0 },
      captionExportsUsed: { type: Number, default: 0 },
      customPresetsUsed: { type: Number, default: 0 },
